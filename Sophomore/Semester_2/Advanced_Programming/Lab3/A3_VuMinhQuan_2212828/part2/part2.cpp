...
int main()
{
  ...
  University *university = University::getInstance("My University");
  int choice = 0;
  ...
  do
  {
    ...
    case 1:
      ...
      university->addStudent(new UniStudent(name, dob, school, course, semesters));
      break;
    case 2:
      ...
      university->addStudent(new CollegeStudent(name, dob, school, course, semesters));
      break;
    case 3:
