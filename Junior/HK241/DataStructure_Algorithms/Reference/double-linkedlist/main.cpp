...
//^ g++ -o main main.cpp Double_Linked_List.cpp -I.-std=c++11
...
//~ input2 - check selectionSort, subDouble_Linked_List, reverse -> ./main input2.txt
...
int main(int argc, char ** argv) {
    ...
    while(getline(input, str)){
        ...
        else if(signature == "SubDouble_Linked_List"){
            int from, to;
            ss >> from >> to;
            newlist = list.SubDouble_Linked_List(from, to);
            cout << "row " << count << ": ";
